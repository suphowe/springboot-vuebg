/*
 ...
 Source Server         : PostgreSQL_192.168.200.112
 Source Server Type    : PostgreSQL
 Source Server Version : 90519
 Source Host           : 192.168.200.112:5432
 Source Catalog        : suphowe
...
-- ----------------------------
DROP TABLE IF EXISTS "public"."m_blog";
CREATE TABLE "public"."m_blog" (
...
CREATE TABLE "public"."m_user" (
  ...
  "status" int4,
  "created" timestamp(6) DEFAULT NULL::timestamp without time zone,
  "last_login" timestamp(6) DEFAULT NULL::timestamp without time zone
)
;
...
-- Records of m_user
-- ----------------------------
INSERT INTO "public"."m_user" VALUES ('1', 'admin', 'https://image-1300566513.cos.ap-guangzhou.myqcloud.com/upload/images/5a9f48118166308daba8b6da7e466aab.jpg', NULL, '96e79218965eb72c92a549dd5a330112', 0, '2020-04-20 10:44:01', NULL);

-- ----------------------------
-- Primary Key structure for table m_blog
-- ----------------------------
ALTER TABLE "public"."m_blog" ADD CONSTRAINT "m_blog_pkey" PRIMARY KEY ("id");
